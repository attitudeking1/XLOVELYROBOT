...
def tushar(update: Update, context: CallbackContext):
    site_search(update, context, "tushar")


@run_async
def harshu(update: Update, context: CallbackContext):
    site_search(update, context, "harshu")
...
*Available commands:*
 ...
 • `/tushar <anime>`*:* search an anime on animekaizoku.com
 • `/harshu <anime>`*:* search an anime on animekayo.com
...
TUSHAR_SEARCH_HANDLER = DisableAbleCommandHandler("tushar", tushar)
HARSHU_SEARCH_HANDLER = DisableAbleCommandHandler("harshu", harshu)
...
dispatcher.add_handler(TUSHAR_SEARCH_HANDLER)
dispatcher.add_handler(HARSHU_SEARCH_HANDLER)
...
__handlers__ = [
    ...
    USER_HANDLER,
    UPCOMING_HANDLER,
    TUSHAR_SEARCH_HANDLER,
    HARSHU_SEARCH_HANDLER,
    AIRING_HANDLER,
]
