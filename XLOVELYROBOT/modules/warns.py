...
import telegram
from XLOVELYROBOT import TIGERS, WOLVES, dispatcher
from XLOVELYROBOT.modules.disable import DisableAbleCommandHandler
from XLOVELYROBOT.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    is_user_admin,
    user_admin,
...
from XLOVELYROBOT.modules.helper_funcs.extraction import (
    extract_text,
    extract_user,
...
from XLOVELYROBOT.modules.helper_funcs.string_handling import split_quotes
from XLOVELYROBOT.modules.log_channel import loggable
from XLOVELYROBOT.modules.sql import warns_sql as sql
