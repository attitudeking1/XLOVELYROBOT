...
import XLOVELYROBOT.modules.sql.notes_sql as sql
from XLOVELYROBOT import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from XLOVELYROBOT.__main__ import DATA_IMPORT
from XLOVELYROBOT.modules.helper_funcs.chat_status import user_admin
from XLOVELYROBOT.modules.helper_funcs.alternate import typing_action

# from XLOVELYROBOT.modules.rules import get_rules
import XLOVELYROBOT.modules.sql.rules_sql as rulessql

# from XLOVELYROBOT.modules.sql import warns_sql as warnssql
import XLOVELYROBOT.modules.sql.blacklist_sql as blacklistsql
from XLOVELYROBOT.modules.sql import disable_sql as disabledsql

# from XLOVELYROBOT.modules.sql import cust_filters_sql as filtersql
# import XLOVELYROBOT.modules.sql.welcome_sql as welcsql
import XLOVELYROBOT.modules.sql.locks_sql as locksql
from XLOVELYROBOT.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("XLOVELYROBOT{}.backup".format(chat_id), "w") as f:
