...
from XLOVELYROBOT import telethn as XLOVELYROBOTTelethonClient
from XLOVELYROBOT.modules.helper_funcs.telethn.chatstatus import user_is_admin


@XLOVELYROBOTTelethonClient.on(events.NewMessage(pattern=f"^[!/]zombies ?(.*)"))
