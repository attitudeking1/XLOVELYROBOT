...
import XLOVELYROBOT.modules.sql.feds_sql as sql
...
from XLOVELYROBOT.modules.helper_funcs.string_handling import markdown_parser
    ...
    if args:
        if args[0] == "json":
            ...
            with BytesIO(str.encode(backups)) as output:
                output.name = "XLOVELY_fbanned_users.json"
                update.effective_message.reply_document(
                    document=output,
                    filename="XLOVELY_fbanned_users.json",
